    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <!-- form start -->
        <form id="form" action=
        "{{url('update')."/".$data->id}}"  method="POST" enctype="multipart/form-data" >
        <div class="card-body">
            @csrf
            @method('PUT')
            <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="custom-file">
                        <label class="" for="exampleInputFile">Profile Pic</label>
                        <input type="file" class="form-control " id="exmpleInputFile" name="profile_image">
